                ...
                return <div>
                  <div className='border rounded-lg bg-white shadow-lg p-5 space-y-8 relative'>
                    ...
                    >
                      ...
                      {/* Technical title */}
                      <div className=''>
                        <h1 className={i.isTeamLeader ? 'text--500 text-lg' : 'text-gray-500'}>{i.isTeamLeader ? 'Team leader' : 'Technical'}</h1>
                      </div>
                    </div>
                    ...
                    <div className='flex justify-between items-center'>
                      {
                        false ? (
                          <div className='flex items-center space-x-2'>
                            ...
                            <h1 className='text-green-600 font-semibold'>Available</h1>
                          </div>
                        ) : (
                          <div className='flex items-center space-x-2'>
                            <input type="radio" checked={false} disabled />
                            <h1 className='text-red-600 font-semibold'>Un available</h1>
                          </div>
                        )
                      }
